                        ...
                        <table class="table table-striped custom-table datatable">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td>987654321 </td>
                                    <td><span class="custom-badge status-red">Progress</span></td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ url('booking-history') }}"><i class="fas fa-eye m-r-5"></i> View</a>
                                ...
                                <tr>
                                    ...
                                    <td>987654321 </td>
                                    <td><span class="custom-badge status-blue">Completed</span></td>
                                    <td class="text-right">
                                        <div class="dropdown dropdown-action">
                                            <a href="#" class="action-icon dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fas fa-ellipsis-v"></i></a>
                                            <div class="dropdown-menu dropdown-menu-right">
                                                <a class="dropdown-item" href="{{ url('booking-history') }}"><i class="fas fa-eye m-r-5"></i> Edit</a>
                                                <a class="dropdown-item" href="#" onclick="showConfirmMessage()"><i class="fas fa-trash-alt m-r-5"></i> Delete</a>
                                            </div>
                                        </div>
                                    </td>
